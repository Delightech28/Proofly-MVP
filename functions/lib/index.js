...
exports.awardVerificationXP = exports.processReferralRequest = void 0;
 ...
 */
exports.processReferralRequest = functions.firestore
    ...
    try {
        ...
        await db.runTransaction(async (transaction) => {
            ...
            if (newUserData === null || newUserData === void 0 ? void 0 : newUserData.referredBy) {
 ...
 */
exports.awardVerificationXP = functions.firestore
